...
var bind = function(func, context){
  // Store any additional arguments into a new array
  var boundArgs = Array.prototype.slice.call(arguments, 2);

  return function(){
    // Store arguments of this invocation
    var newArgs = Array.prototype.slice.call(arguments, 0);

    // Invoke the bound function, providing it both
    // the bound and new arguments. We use apply since
    // the arguments will all be stored in an array
    // Also return whatever value is returned after
    // executing the function
    return func.apply(context, boundArgs.concat(newArgs));
  }
};

// Mostly same as above, but the func argument is now
// contextual and stored in 'this' which we'll save off
